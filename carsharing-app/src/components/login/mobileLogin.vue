    ...
    <div class="login-switch-area">
        <form id="form-login" name="form-login" v-on:submit.prevent="submitByMobile">
            <div class="form-group">
                ...
                <input class="form-input" placeholder="请输入您的工号" name="userNo" v-model="userNo" type="tel" autocomplete="off" maxlength="5"
                    required autofocus>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-input" placeholder="请输入您的手机号" name="mobile" type="tel" v-model="mobile" autocomplete="off" required value=""
                    maxlength="11">
            </div>
            <div class="error-hint">

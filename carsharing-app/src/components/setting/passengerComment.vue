    ...
    <div class="setting-container">
        ...
        <div class="comment-datail">
            ...
            <div>
                ...
                <div class="passages-comment-list-bg" :style="{display:passageComment.isShowMap}">
                    ...
                    <div class="has-passanger-comment">
                        ...
                        <div class="passanger-comment-spiltline"></div>
                        <Star v-bind:score="compositeScore" />
                        <div class="has-passanger-comment-input" v-if="passageComment.isFinished == true">
                            <span class="triangle"></span>
                            <span class="has-passanger-comment-input">你对司机说，司机大哥太贴心了下雨还把…</span>
                        </div>
                        <div class="comment-input" v-if="passageComment.isFinished == false">
